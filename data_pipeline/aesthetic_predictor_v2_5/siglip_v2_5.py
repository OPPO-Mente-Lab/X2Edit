...
class AestheticPredictorV2_5Processor(SiglipImageProcessor):
    ...
    def from_pretrained(
        ...
        | PathLike = "/mnt/data/group/models/siglip-so400m-patch14-384",
        *args,
        **kwargs,
...
def convert_v2_5_from_siglip(
    predictor_name_or_path: str ="/mnt/data/group/**/data_process/aesthetic-predictor-v2-5-main/models/aesthetic_predictor_v2_5.pth",
    encoder_model_name: str = "/mnt/data/group/models/siglip-so400m-patch14-384",
    *args,
    **kwargs,
