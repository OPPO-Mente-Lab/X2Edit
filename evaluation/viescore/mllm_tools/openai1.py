...
class GPT4v():
    def __init__(self, api_key_path='keys/secret.env', are_images_encoded=False, model_name="gpt-4-vision-preview"):
        ...
        self.url="https://andesgpt-gateway-cn.heytapmobi.com/chat/v1/completions",
    ...
    def get_parsed_output(self, prompt):
        ...
        if len(messages)==3:
            messages_new = [{
                    ...
                    "images": [{
                        "url": get_base64(messages[1]["image_url"]["url"]),
                        "detail":"high" 
                        },
                        {
                        "url": get_base64(messages[2]["image_url"]["url"]),
                        "detail":"high" 
                        }
                    ]
                    }
        ...
        resp = requests.request(
            "POST",
            url="https://andesgpt-gateway-cn.heytapmobi.com/chat/v1/completions",
            headers=header,
            data=data,
