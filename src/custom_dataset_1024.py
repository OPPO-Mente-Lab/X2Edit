...
class DataModuleCustom(LightningDataModule):
    ...
    def add_data_specific_args(parent_args):
        ...
        parser.add_argument('--webdataset_base_urls', type=str, nargs="+", default=["/home/notebook/data/group/group/text2img_data/X2I/tars/anyedit/*/*"])
...
BUCKET_PROBS = [0.05, 0.012, 0.006, 0.029, 0.025, 0.067, 0.499, 0.064, 0.025, 0.075, 0.036, 0.045, 0.067]
...
def to_type_id(target_value):
    all_dict = {
        ...
        '5':['颜色更改','color_alter','Colorization'],
		'6':['材料更改','material_alter','材质更改','material_change','visual_material_change'],
		'7':['动作更改','motion_change','action_change','attribute_modification'],
...
def verify_keys(samples, required_keys, handler=wds.handlers.reraise_exception):
    ...
    for sample in samples:
        ...
        # if w/h>1.2 or h/w>1.2:continue
        ...
        if "label" in sample_json:
            ...
            if label=="grit-entity-new": ## person
                ...
                if sample_json["task"]=="文字更改" and not bool(re.search('[a-zA-Z]', sample_json["instruction"])):
                    # print(sample_json["instruction"])
                    continue
                ...
                if "score_7b" in sample_json:
                    ...
                    # if sample_json["task"] in ["背景更改","色调变换","删除主体","颜色更改","材料更改"]:
                    #     continue
                    if "aesthetic_score" in sample_json:
                        if sample_json["aesthetic_score"]<6:
                            continue
...
class ImageEmbeddingDataset(wds.DataPipeline, wds.compat.FluidInterface):
    ...
    def preproc(self, sample):
        ...
        if "label" in sample_json:
            ...
            elif "instruction" not in sample_json and type(sample_json["caption_en"])==list:
                instruction_en = random.choice(sample_json["caption_en"])
                instance_image_infer = sample[f"1.0.jpg"].convert("RGB")
                instance_image = sample[f"2.jpg"].convert("RGB")
                edit_type = sample_json["label"]
        ...
        # print(instruction_en,edit_type)
        ...
        contents=[{"type": "text", "text": instruction_en}]
        message = [
            {
                "role": "user",
                "content": contents
        ...
        inputs = self.tokenizer_t5(text=[text], images=None, videos=None, padding="max_length", max_length=512, truncation=True, return_tensors="pt")
...
if __name__ == '__main__':
    ...
    # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/web-image/*/*"]
    urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/subject/Subjects200K/1/*"]
    urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/subject/Subjects200K/0/*"]
    # urls=["/home/notebook/data/group/group/xuguo/gendata/outputs_flux/*/*"]
    # # urls=["/home/notebook/data/group/group/text2img_data/style/*/*"]
    # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/anyedit/*/*"]
    urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/OmniEdit/*/*"]
    # # # # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/PromptfixData/*/*"]
    # # # # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/SEED-Data/*/*"]
    # # # # # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/SEED-Data-Unsplash/*/*"]
    # # # # # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/grit-entity-new/*/*"]
    # # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/bagel_stage1/*/*"]
    # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/gpt4o/*/*"]
    # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/Kontext/*/*"]
    # # # urls=["/home/notebook/data/group/group/******/textflux-main/textflux-qwen-generate-en/*/*"]
    # urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/Kontext_subject/*/*"]
    urls=["/home/notebook/data/group/group/text2img_data/X2I/tars/ShareGPT-4o-Image/*/*"]
    ...
    for url in urls:
        if "*" in url:
            ...
            all_urls = urls
    print(len(all_urls))
    paths = "/home/notebook/data/group/group/models/Qwen2.5-VL-7B-Instruct"
    teacher = "/home/notebook/data/group/group/models/flux/shuttle-3-diffusion"
    tokenizer_t5 = AutoProcessor.from_pretrained(paths, trust_remote_code=True, use_fast=False)
    text_encoder_t5 = Qwen2_5_VLForConditionalGeneration.from_pretrained(paths, torch_dtype=torch.bfloat16).to(device)
