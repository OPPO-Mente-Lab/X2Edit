...
class DataModuleCustom(LightningDataModule):
    ...
    def add_data_specific_args(parent_args):
        ...
        parser.add_argument('--webdataset_base_urls', type=str, nargs="+", default=["/mnt/data/group/text2img_data/X2I/tars/anyedit/*/*"])
...
if __name__ == '__main__':
    ...
    # urls=["/mnt/data/group/text2img_data/X2I/tars/web-image/*/*"]
    urls=["/mnt/data/group/text2img_data/X2I/tars/subject/Subjects200K/1/*"]
    urls=["/mnt/data/group/text2img_data/X2I/tars/subject/Subjects200K/0/*"]
    # urls=["/mnt/data/group/xuguo/gendata/outputs_flux/*/*"]
    # # urls=["/mnt/data/group/text2img_data/style/*/*"]
    # urls=["/mnt/data/group/text2img_data/X2I/tars/anyedit/*/*"]
    # # # # urls=["/mnt/data/group/text2img_data/X2I/tars/OmniEdit/*/*"]
    # # # urls=["/mnt/data/group/text2img_data/X2I/tars/PromptfixData/*/*"]
    # # # urls=["/mnt/data/group/text2img_data/X2I/tars/SEED-Data/*/*"]
    urls=["/mnt/data/group/text2img_data/X2I/tars/style//*/*"]
    # urls=["/mnt/data/group/text2img_data/X2I/tars/step1x_7b_72b/*/*"]
    # urls=["/mnt/data/group/text2img_data/X2I/tars/bagel_stage1/*/*"]
    # urls=["/mnt/data/group/text2img_data/X2I/tars/delete/*/*"]
    urls=["/mnt/data/group/text2img_data/X2I/tars/Kontext/*/*"]
    # # # urls=["/mnt/data/group/******/textflux-main/textflux-qwen-generate-en/*/*"]
    # urls=["/mnt/data/group/text2img_data/X2I/tars/Kontext_aspect/*/*"]
